...
const FALLBACK_ORDER = ['GROQ', 'CEREBRAS', 'SAMBANOVA', 'NVIDIA', 'OPENROUTER', 'DEEPSEEK', 'GEMINI', 'MISTRAL', 'TOGETHER', 'OPENAI'];
...
module.exports = { API_CONFIGS, FALLBACK_ORDER, callAI, getErrorLog, getRecentErrors };
